...
let tectonic_plate_GeoJSON = "https://raw.githubusercontent.com/fraxen/tectonicplates/master/GeoJSON/PB2002_boundaries.json";
...
d3.json(tectonic_plate_GeoJSON).then(function(data){
	console.log(data);
